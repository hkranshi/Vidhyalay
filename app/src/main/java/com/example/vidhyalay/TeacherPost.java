...
import java.io.IOException;
public class TeacherPost extends AppCompatActivity {
    ImageView imageView;
    EditText text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=findViewById(R.id.myImage1);
        choose=findViewById(R.id.chose1);
        upload=findViewById(R.id.uplo1);
        text=findViewById(R.id.title2);
    ...
    private void uploadImage(View v) {
        ...
        if(filepath!=null){
            ...
            Toast.makeText(TeacherPost.this,"Please Select Image",Toast.LENGTH_LONG).show();
        }
    ...
    private void uploadFirebase(Uri filepath) {
        ...
        fileref.putFile(filepath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Post_Member member=new Post_Member(uri.toString(),t1, Teach.name1);
                        String mid=root.push().getKey();
                        root.child(mid).setValue(member);
                        Toast.makeText(TeacherPost.this,"Uploaded Successfully",Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                // progressBar.setVisibility(View.INVISIBLE);
                Toast.makeText(TeacherPost.this,"Uploading Failed !!",Toast.LENGTH_LONG).show();
            }
        });
    }
